  ...
  introduccionQuestions: Question[] = [
    ...
    },
    {
      ...
      options: [
        ...
        'Misión 3 Quiver Vision.'
      ],
      correct: 2
    },
    {
      id: 9,
      text: '¿Qué diferencia fundamentalmente a la Misión 6 de las demás misiones en esta plataforma?',
      options: [
        'La Misión 6 usa realidad virtual en lugar de realidad aumentada.',
        'En la Misión 6 la camara lee el QR y solo activa la visualización del modelo en cuestión.',
        'La Misión 6 no necesita de ninguna plataforma externa para funcionar, es decir, se utiliza tecnología propia para generar el modelo 3D y su visualización.',
        'Los modelos de la misión 6 son en 2D.'
      ],
      correct: 1
    },
    {
